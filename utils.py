...
def get_upcoming_matches():
    ...
    # Generate IPL 2025 match schedule based on official data
    today = datetime.now()
    
    # For IPL 2025 schedule (March-May 2025)
    # Using the official IPL 2025 schedule
    
    # Official IPL 2025 matches
    ipl_matches = [
        {
            'match_number': 1,
        ...
        },
        {
            ...
            'city': "Visakhapatnam",  # Note: DC playing in Vizag
            'match_type': "T20",
            'start_time': "7:30 PM",
